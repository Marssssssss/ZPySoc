...
NET_HELP_TIPS_ALL = "[Server]Some command used below:\n" \
                    ...
                    "  $rollstart keepTimes      (to start a roll game which will end in keepTimes secs, keepTimes <= " \
                                                 "300)\n" \
                    "  $roll                     (to roll a number for yourself when a roll game is processing)\n"\
                    "  $help [command]           (just to get help!!!)"
...
tipsForSingleCommand = {
    NET_HELP_TIP_HELP: "$help [command] (just to get help!!!)"
}